...
Проверка та же, что у `test_mcp_skill.py::test_every_tool_named_in_the_skill_exists` для
скила: сверить **множества** имён, а не глазами (`docs/CONVENTIONS.md`, «Документация»).
