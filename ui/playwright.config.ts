  ...
  projects: [
    {
      name: 'светлая',
      testIgnore:
        /(access|answer|board-column|case-readable|case-latest|key-wrap|link-groups|live|live-board|live-list|long-word|moving|paging|layout|reason-line|group-chevron-align|task-list-screen|remark|people|parents-long|hierarchy|section-edits|service-i18n|language|language-formats|english)\.spec\.ts/,
    ...
    },
    {
      name: 'запись',
      testMatch:
        /(access|answer|board-column|case-readable|case-latest|key-wrap|link-groups|live|live-board|live-list|long-word|moving|paging|layout|reason-line|group-chevron-align|task-list-screen|remark|people|parents-long|hierarchy|section-edits|service-i18n)\.spec\.ts/,
