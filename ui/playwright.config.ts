  ...
  projects: [
    {
      name: 'светлая',
      testIgnore:
        /(access|answer|board-column|case-readable|case-latest|live|live-board|live-list|paging|layout|task-list-screen|remark|parents-long|language|language-formats|english)\.spec\.ts/,
    ...
    },
    {
      name: 'запись',
      testMatch:
        /(access|answer|board-column|case-readable|case-latest|live|live-board|live-list|paging|layout|task-list-screen|remark|parents-long)\.spec\.ts/,
