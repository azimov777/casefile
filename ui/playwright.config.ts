  ...
  projects: [
    {
      name: 'светлая',
      testIgnore:
        /(access|answer|board-column|case-readable|case-latest|key-wrap|link-groups|live|live-board|live-list|long-word|moving|paging|layout|task-list-screen|remark|people|parents-long|section-edits|language|language-formats|english)\.spec\.ts/,
    ...
    },
    {
      name: 'запись',
      testMatch:
        /(access|answer|board-column|case-readable|case-latest|key-wrap|link-groups|live|live-board|live-list|long-word|moving|paging|layout|task-list-screen|remark|people|parents-long|section-edits)\.spec\.ts/,
