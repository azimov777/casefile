  ...
  projects: [
    {
      name: 'светлая',
      testIgnore:
        /(answer|board-column|case-readable|case-latest|live|live-list|paging|layout|task-list-screen|remark|language|language-formats|english)\.spec\.ts/,
    ...
    },
    {
      name: 'запись',
      testMatch:
        /(answer|board-column|case-readable|case-latest|live|live-list|paging|layout|task-list-screen|remark)\.spec\.ts/,
