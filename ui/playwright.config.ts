...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      name: 'запись',
      testMatch:
        /(access|answer|board-column|case-readable|case-latest|key-wrap|link-groups|live|live-board|live-list|long-word|moving|paging|layout|reason-line|group-chevron-align|task-list-screen|remark|people|parents-long|project-place|project-screen|hierarchy|section-edits|service-i18n)\.spec\.ts/,
