  ...
  projects: [
    {
      name: 'светлая',
      testIgnore:
        /(access|answer|board-column|case-readable|case-latest|link-groups|live|live-board|live-list|moving|paging|layout|task-list-screen|remark|people|parents-long|section-edits|language|language-formats|english)\.spec\.ts/,
    ...
    },
    {
      name: 'запись',
      testMatch:
        /(access|answer|board-column|case-readable|case-latest|link-groups|live|live-board|live-list|moving|paging|layout|task-list-screen|remark|people|parents-long|section-edits)\.spec\.ts/,
