...
export default defineConfig({
  ...
  projects: [
    {
      name: 'светлая',
      testIgnore: /(answer|case-readable|live|live-list|paging|layout|task-list-screen)\.spec\.ts/,
    ...
    {
      name: 'запись',
      testMatch: /(answer|case-readable|live|live-list|paging|layout|task-list-screen)\.spec\.ts/,
