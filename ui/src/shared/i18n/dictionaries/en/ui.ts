...
export const ui = {
   ...
   * интерфейса (`shared/lib/time.ts`); словами сказана одна ступень — та, которой
  ...
  app: {
    ...
    // интерфейса: рядом с ней стоит само название, и разойтись они не должны.
    mark: 'T',
    name: 'Tracker',
    sections: 'Sections',
    trackerSections: 'Tracker sections',
