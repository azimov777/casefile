...
export const errors = {
  ...
  archive_revision_unknown:
    'Архив снят более новой версией Casefile. Сначала обновите эту установку, затем повторите приём.',
  assignee_mismatch: 'Задача поручена другому исполнителю.',
  assignee_required: 'У задачи нет исполнителя.',
  attribute_not_found: 'У проекта нет атрибута с таким именем.',
  attribute_reason_required: 'Изменение и снятие атрибута требуют причины.',
  attribute_value_too_long: 'Значение атрибута слишком длинное.',
  ...
  invalid_project_key: 'Ключ проекта не соответствует шаблону.',
