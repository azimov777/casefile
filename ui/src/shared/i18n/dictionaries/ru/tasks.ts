...
export const tasks = {
  ...
  table: {
    // Имя рамки, а не таблицы, и существует оно не всегда: рамка объявляет себя
    // прокручиваемой областью ровно там, где её и правда есть куда прокручивать.
    // Где прокручивать нечего, у рамки нет ни имени, ни роли, и таблицу диктору
    // представляет `caption` ниже (UI-91).
    scrollable: 'Задачи, таблица прокручивается вбок',
