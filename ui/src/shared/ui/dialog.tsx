    ...
    <DialogPrimitive.Root open={open} onOpenChange={onOpenChange}>
      <DialogPrimitive.Portal>
        ...
        >
           ...
           *
           * `[&>*]:shrink-0` — не украшение: у элемента колонки флекса автоматический
           * минимум высоты действует, только пока его собственный `overflow` —
           * `visible`. Блок копирования (`CopyBlock`) объявлен `overflow-hidden` ради
           * скруглённых углов, минимум у него обнуляется, и в переполненной колонке он
           * схлопывался до полоски в пиксель — секрет выпущенного токена просто исчезал
           * с виду (`docs/notes/ui.md`).
           */}
