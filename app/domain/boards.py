"""Доски, колонки и шкала порядка карточек.
...
def _validate_line(
    ...
    *,
    ...
    Одно правило на доску и на колонку: обе показываются строкой в заголовке, и две
    копии проверки разошлись бы обработкой возврата каретки.
    """
