...
установкой, а не работа над задачей; туда же — архивирование и восстановление проекта
(`archive_project`, `restore_project`). Исключение — атрибуты проекта (`set_attribute`,
